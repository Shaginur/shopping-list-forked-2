...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/js/shopping.js":[function(require,module,exports) {
"use strict";
...
exports.exportLowerCasedCSV = exportLowerCasedCSV;
/**
...
},{"./url-alphabet/index.js":"node_modules/nanoid/url-alphabet/index.js"}],"node_modules/dayjs/dayjs.min.js":[function(require,module,exports) {
var define;
...
var form = document.querySelector("#shopping-list-form");
var itemName = document.querySelector("#item-name");
var list = document.querySelector("#shopping-list");
var exportedJson = document.querySelector("#exported-json");
var items = [];
function render(items) {
  console.log("Items: " + items.join(", "));
  list.innerHTML = "";
  items.forEach(function (item) {
    list.insertAdjacentHTML("beforeend", "<li><div id=\"".concat(item.id, "\" class=\"card  ").concat(item.priority, "\">").concat(item.date, " ").concat(item.value, "</div></li>"));
  });
  exportedJson.textContent = (0, _shopping.exportLowerCasedCSV)(items);
}
form.addEventListener("submit", function (event) {
  ...
  var newItem = {
    id: (0, _nanoid.nanoid)(),
    date: (0, _dayjs.default)().format("DD-MM-YYYY HH:mm:ss"),
    priority: priority.value,
    value: itemName.value
  };
  items = (0, _shopping.addItem)(items, newItem);
  itemName.value = "";
  render(items);
});
render(items);
},{"./shopping.js":"src/js/shopping.js","nanoid":"node_modules/nanoid/index.browser.js","dayjs":"node_modules/dayjs/dayjs.min.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
